...
fun buildInstructionTable() {
    ...
    INSTAB[0x90] = INSTR(IT.BRQ, AM.RELATIVE, RT.NONE, FT.C)
    INSTAB[0x91] = INSTR(IT.STQ, AM.INDIRECT_Y, RT.A, FT.NONE)
    INSTAB[0x94] = INSTR(IT.STQ, AM.ZEROPAGE_X, RT.Y, FT.NONE)
    INSTAB[0x95] = INSTR(IT.STQ, AM.ZEROPAGE_X, RT.A, FT.NONE)
    INSTAB[0x96] = INSTR(IT.STQ, AM.ZEROPAGE_Y, RT.X, FT.NONE)
    INSTAB[0x98] = INSTR(IT.TYA, AM.IMPLIED, RT.A, FT.NONE)
    INSTAB[0x99] = INSTR(IT.STQ, AM.ABSOLUTE_Y, RT.A, FT.NONE)
    INSTAB[0x9A] = INSTR(IT.TXS, AM.IMPLIED, RT.SR, FT.NONE)
    INSTAB[0x9D] = INSTR(IT.STQ, AM.ABSOLUTE_X, RT.A, FT.NONE)

    INSTAB[0xA0] = INSTR(IT.LDQ, AM.IMMEDIATE, RT.Y, FT.NONE)
    INSTAB[0xA1] = INSTR(IT.LDQ, AM.X_INDIRECT, RT.A, FT.NONE)
    INSTAB[0xA2] = INSTR(IT.LDQ, AM.IMMEDIATE, RT.X, FT.NONE)
    INSTAB[0xA4] = INSTR(IT.LDQ, AM.ZEROPAGE, RT.Y, FT.NONE)
    INSTAB[0xA5] = INSTR(IT.LDQ, AM.ZEROPAGE, RT.A, FT.NONE)
    INSTAB[0xA6] = INSTR(IT.LDQ, AM.ZEROPAGE, RT.X, FT.NONE)
    INSTAB[0xA8] = INSTR(IT.TAY, AM.IMPLIED, RT.Y, FT.NONE)
    INSTAB[0xA9] = INSTR(IT.LDQ, AM.IMMEDIATE, RT.A, FT.NONE)
    INSTAB[0xAA] = INSTR(IT.TAX, AM.IMPLIED, RT.X, FT.NONE)
    INSTAB[0xAC] = INSTR(IT.LDQ, AM.ABSOLUTE, RT.Y, FT.NONE)
    INSTAB[0xAD] = INSTR(IT.LDQ, AM.ABSOLUTE, RT.A, FT.NONE)
    INSTAB[0xAE] = INSTR(IT.LDQ, AM.ABSOLUTE, RT.X, FT.NONE)

    INSTAB[0xB0] = INSTR(IT.BRQ, AM.RELATIVE, RT.NONE, FT.C)
    INSTAB[0xB1] = INSTR(IT.LDQ, AM.INDIRECT_Y, RT.A, FT.NONE)
    INSTAB[0xB4] = INSTR(IT.LDQ, AM.ZEROPAGE_X, RT.Y, FT.NONE)
    INSTAB[0xB5] = INSTR(IT.LDQ, AM.ZEROPAGE_X, RT.A, FT.NONE)
    INSTAB[0xB6] = INSTR(IT.LDQ, AM.ZEROPAGE_X, RT.X, FT.NONE)
    INSTAB[0xB8] = INSTR(IT.CLQ, AM.IMPLIED, RT.NONE, FT.V)
    INSTAB[0xB9] = INSTR(IT.LDQ, AM.ABSOLUTE_Y, RT.A, FT.NONE)
    INSTAB[0xBA] = INSTR(IT.TSX, AM.IMPLIED, RT.X, FT.NONE)
    INSTAB[0xBC] = INSTR(IT.LDQ, AM.ABSOLUTE_X, RT.Y, FT.NONE)
    INSTAB[0xBD] = INSTR(IT.LDQ, AM.ABSOLUTE_X, RT.A, FT.NONE)
    INSTAB[0xBE] = INSTR(IT.LDQ, AM.ABSOLUTE_Y, RT.X, FT.NONE)
}
