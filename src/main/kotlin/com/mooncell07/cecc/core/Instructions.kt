...
fun buildInstructionTable() {
    ...
    INSTAB[0xC0] = INSTR(IT.COMPARE, AM.IMMEDIATE, RT.NONE, FT.NONE)
    INSTAB[0xC1] = INSTR(IT.COMPARE, AM.X_INDIRECT, RT.NONE, FT.NONE)
    INSTAB[0xC4] = INSTR(IT.COMPARE, AM.ZEROPAGE, RT.NONE, FT.NONE)
    INSTAB[0xC5] = INSTR(IT.COMPARE, AM.ZEROPAGE, RT.NONE, FT.NONE)
    INSTAB[0xC6] = INSTR(IT.DECREMENT, AM.ZEROPAGE, RT.NONE, FT.NONE)
    INSTAB[0xC8] = INSTR(IT.INCREMENT, AM.IMPLIED, RT.Y, FT.NONE)
    INSTAB[0xC9] = INSTR(IT.COMPARE, AM.IMMEDIATE, RT.NONE, FT.NONE)
    INSTAB[0xCA] = INSTR(IT.DECREMENT, AM.IMPLIED, RT.X, FT.NONE)
    INSTAB[0xCC] = INSTR(IT.COMPARE, AM.ABSOLUTE, RT.Y, FT.NONE)
    INSTAB[0xCD] = INSTR(IT.COMPARE, AM.ABSOLUTE, RT.NONE, FT.NONE)
    INSTAB[0xCE] = INSTR(IT.DECREMENT, AM.ABSOLUTE, RT.NONE, FT.NONE)

    INSTAB[0xD0] = INSTR(IT.BRANCH, AM.RELATIVE, RT.NONE, FT.Z)
    INSTAB[0xD1] = INSTR(IT.COMPARE, AM.INDIRECT_Y, RT.NONE, FT.NONE)
    INSTAB[0xD5] = INSTR(IT.COMPARE, AM.ZEROPAGE_X, RT.NONE, FT.NONE)
    INSTAB[0xD6] = INSTR(IT.DECREMENT, AM.ZEROPAGE_X, RT.NONE, FT.NONE)
    INSTAB[0xD8] = INSTR(IT.CLEAR, AM.IMPLIED, RT.NONE, FT.D)
    INSTAB[0xD9] = INSTR(IT.COMPARE, AM.ABSOLUTE_Y, RT.NONE, FT.NONE)
    INSTAB[0xDD] = INSTR(IT.COMPARE, AM.ABSOLUTE_X, RT.NONE, FT.NONE)
    INSTAB[0xDE] = INSTR(IT.DECREMENT, AM.ABSOLUTE_X, RT.NONE, FT.NONE)

    INSTAB[0xE0] = INSTR(IT.COMPARE, AM.IMMEDIATE, RT.NONE, FT.NONE)
    INSTAB[0xE1] = INSTR(IT.SBC, AM.X_INDIRECT, RT.A, FT.NONE)
    INSTAB[0xE4] = INSTR(IT.COMPARE, AM.ZEROPAGE_X, RT.NONE, FT.NONE)
    ...
    INSTAB[0xEC] = INSTR(IT.COMPARE, AM.ABSOLUTE, RT.NONE, FT.NONE)
    INSTAB[0xED] = INSTR(IT.SBC, AM.ABSOLUTE, RT.A, FT.NONE)
    INSTAB[0xEE] = INSTR(IT.INCREMENT, AM.ABSOLUTE, RT.X, FT.NONE)

    INSTAB[0xF0] = INSTR(IT.BRANCH, AM.RELATIVE, RT.NONE, FT.Z)
